...
Desenvolvimento de uma aplicação focada na gestão de pacientes e agendamentos médicos, estruturada para oferecer uma interface fluida no ecossistema da Apple/Android e integração em tempo real com a base de dados.

### ⚙️ Automação de Processos de GMUD
> *Backend | C# .NET | IA*

Sistema focado na geração automatizada de scripts e instruções de deploy para processos de Change Management (GMUD) a partir da leitura e interpretação de documentos PDF.
